...
The implementation below uses \pythoninline{while}-loop instead, which avoids Python's issues with recursion but looks very different from the intuitive description of binary search.
